...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
              ...
              <div class="box-header" style="margin-bottom: 63px;">
                <div class="row">
                  ...
                  <div class="col-sm-2 col-sm-offset-10 ml-auto float-right" style="margin-right: 15px">
                    <a href="JavaScript:void(0)" class="btn btn-purple btn-block mb-4" data-toggle="modal" data-target="#modalNuevaAreaTrabajo">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="box">
                      ...
                      <div class="box-body">
                        <div class="container-fluid">
                          <table id="listAreaTrabajo" class="table-light table-bordered table-striped table-hover" width="98%" cellspacing="0">
                            <thead>
                              <tr>
                                <th>NOMBRE</th>
                                <th>DESCRIPCION</th>
    ...
    <div id="modalNuevaAreaTrabajo" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header header-modal-sany" style="background-color: #6F42C1">
            <div class="container-fluid">
              <h4 class="modal-title " style="text-align: center; color: black">REGISTRAR UNA NUEVA AREA TRABAJO</h4>
            </div>
          </div>

          <div class="modal-body modal-xl">
            <div class="content">
              <form method="POST" name="registrarAreaTrabajo" id="registrarAreaTrabajo" onsubmit="return enviarRegistroAreaTrabajo(event);" action="procesarAreaTrabajo.php?accion=crear">
                <div class="row">
    ...
    <div id="modalModificarAreaTrabajo" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header header-modal-sany" style="background-color: #6F42C1">
            <div class="row">
  ...
  <script type="text/javascript" src="../../js/javascriptIndexAreaTrabajo.js" defer></script>
  <script type="text/javascript">
    ...
    ?>
    <?php echo cargarDataTables('listAreaTrabajo', 'responseAreaTrabajo'); ?>
    <?php
    if (isset($_GET['r'])) {
    ...
    ?>
    if (resquest == "success") {
      swal("Excelente!", "Area Trabajo almacenado correctamente!", "success");
    } else if (resquest == "editado") {
      swal("Excelente!", "Area Trabajo editado correctamente!", "success");
    } else if (resquest == "eliminado") {
      swal("Excelente!", "Area Trabajo eliminado correctamente!", "success");
    ...
    function fnEditarAreaTrabajo(idUsuario) {      
      $.ajax({
        url: "formEditarAreaTrabajo.php",
        type: "POST",
        dataType: "html",
        data: {
          idu: idUsuario
    ...
    function fnEliminarAreaTrabajo(idUsuario) {
      swal({
          title: "Estas seguro que deseas eliminar este Area Trabajo?",
          icon: "warning",
          buttons: true,
          dangerMode: true,
        })
        .then((willDelete) => {
          if (willDelete) {
            ...
            window.location = "<?= $base_url ?>pages/areatrabajo/procesarAreaTrabajo.php?accion=eliminar&id=" + idUsuario;
          }
        });
    }
  </script>
