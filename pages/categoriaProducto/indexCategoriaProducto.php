...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
              ...
              <div class="box-header" style="margin-bottom: 63px;">
                <div class="row">
                  ...
                  <div class="col-sm-2 col-sm-offset-10 ml-auto float-right" style="margin-right: 15px">
                    <a href="JavaScript:void(0)" class="btn btn-purple btn-block mb-4" data-toggle="modal" data-target="#modalNuevaCategoriaProducto">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="box">
                      ...
                      <div class="box-body">
                        <div class="container-fluid">
                          <table id="listCategoriaProducto" class="table-light table-bordered table-striped table-hover" width="98%" cellspacing="0">
                            <thead>
                              <tr>
                                <th>NOMBRE</th>
                                <th>ACCIONES</th>
    ...
    <div id="modalNuevaCategoriaProducto" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body modal-xl">
            <div class="content">
              <form method="POST" name="registrarCategoriaProducto" id="registrarCategoriaProducto" onsubmit="return enviarRegistroCategoriaProducto(event);" action="procesarCategoriaProducto.php?accion=crear">
                <div class="row">
    ...
    <div id="modalModificarCategoriaProducto" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header header-modal-sany" style="background-color: #6F42C1">
            <div class="row">
  ...
  <script type="text/javascript" src="../../js/javascriptIndexCategoriaProducto.js" defer></script>
  <script type="text/javascript">
    ...
    ?>
    <?php echo cargarDataTables('listCategoriaProducto', 'responseCategoriaProducto'); ?>
    <?php
    if (isset($_GET['r'])) {
    ...
    function fnEditarCategoriaProducto(idUsuario) {      
      $.ajax({
        url: "formEditarCategoriaProducto.php",
        type: "POST",
        dataType: "html",
        data: {
          idu: idUsuario
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            window.location = "<?= $base_url ?>pages/categoriaProducto/procesarCategoriaProducto.php?accion=eliminar&id=" + idUsuario;
          }
        });
    }
  </script>
