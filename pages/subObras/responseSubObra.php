...
if (isset($params['search']['value']) && $params['search']['value'] != '') {
    $where .= "
            AND 
                (subO.codigo  LIKE '%" . $params['search']['value'] . "%' 
                OR UPPER(subO.nombre) LIKE '%" . $params['search']['value'] . "%'
                OR CONCAT(CONCAT('$', FORMAT(subO.costo, 2, 'de_DE')),' COP')  LIKE '%" . $params['search']['value'] . "%'
...
$sql = "SELECT 
        ...
        CONCAT(CONCAT('$', FORMAT(subO.costo, 2, 'de_DE')),' COP') costo,
